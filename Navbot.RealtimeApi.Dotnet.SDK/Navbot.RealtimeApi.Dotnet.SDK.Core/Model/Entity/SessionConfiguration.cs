...
namespace Navbot.RealtimeApi.Dotnet.SDK.Core.Model.Entity
{
    public class SessionConfiguration
    {
        ...
        internal Model.Request.Session ToSession(Dictionary<FunctionCallSetting, Func<FunctionCallArgument, JObject>> functionRegistries)
        {
        ...
        internal JArray SetFunctionRegistries(Dictionary<FunctionCallSetting, Func<FunctionCallArgument, JObject>> functionRegistries)
        {
